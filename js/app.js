...
const hourlyChart = document.getElementById('.hourly-chart').getContext('2d');
const weeklyChart = document.getElementById('.weekly-chart').getContext('2d');
const monthlyChart = document.getElementById('.monthly-chart').getContext('2d');
